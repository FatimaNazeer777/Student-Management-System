...
const students: any = []; 
const addStudent = () => inquirer.prompt([
    {
        type: "input",
        name: "name",
...
const displayStudents = () => {
    ...
    students.forEach((student: { name: any; id: any; grade: any; }) =>
console.log(chalk.yellowBright(`Name: ${student.name}, ID: ${student.id}, Grade: ${student.grade}`)));
    promptUser();
};
